...
class GeneralRepository implements GeneralRepositoryInterface{
    ...
    public function __construct(General $general, GeneralTranslation $generalTranslation, User $user, About $about, AboutTranslation $aboutTranslation,Request $request)
    {
