        ...
        <div class="tab-content">
            <div id="english" class="container tab-pane active"><br>
                ...
                <div class="form-group col-sm-7">
                    ...
                    <input class="form-control {{ $errors->has('en_name') ? 'is-invalid' : '' }}" type="text" name="en_name" id="en_name" value="{{ $pcategory->getTranslation('name','en') }}" required>
                    @error('en_name')
            ...
            <div id="arabic" class="container tab-pane fade"><br>
                ...
                <div class="form-group col-sm-7">
                    ...
                    <input class="form-control {{ $errors->has('ar_name') ? 'is-invalid' : '' }}" type="text" name="ar_name" id="ar_name" value="{{ $pcategory->getTranslation('name','ar') }}" required>
                    @error('ar_name')
                    <small class="form-text text-danger"> {{ $message }}</small>
                    @enderror
                </div>
